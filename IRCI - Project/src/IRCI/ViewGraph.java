...
public class ViewGraph extends JApplet{
    ...
    public void init(Graph<String, String> g) {
        this.g = g;
        this.layout = new SpringLayout2<>(this.g);
...
////                for(Map.Entry m : MenuController.articleMap.entrySet()){
////                    temp = (Article)m.getValue();
////                    System.out.println(temp.getReferredtimes());
////                }
//                boolean topic = false;
//                for (String o : MenuController.articleMap.keySet()) {
//                    if (MenuController.articleMap.get(o).equals(i)) {
//                       topic = true;
//                    }
//                }
//                if (MenuController.articleMap.get(i).getReferredtimes() >= 1) return AffineTransform
//                        .getScaleInstance(MenuController.articleMap.get(i).getReferredtimes(), MenuController.articleMap.get(i).getReferredtimes())
