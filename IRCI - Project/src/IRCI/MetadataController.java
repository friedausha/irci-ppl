...
public class MetadataController {
    ...
    public void showDialogBox(){
        try {
            Parent root = FXMLLoader.load(getClass().getResource("ConfirmationBox.fxml"));
            Scene scene = new Scene(root);
            Stage stage = new Stage();
            stage.setScene(scene);
            stage.show();
...
//                readRan();
                ...
                alert2.setContentText("Process is completed");
                alert2.showAndWait();
            }
        }  else {
...
//                else if(i==6) temp.setAbstr(line);
...
//                System.out.println(x);
    ...
    private void viewGraph(Graph<String, String> graph){
        ViewGraphController demo = new ViewGraphController();
